...
class Genderanal(Keywordanal):
    ...
    def get_results(self, keyword_list) -> dict:
        # initial keyword dictionary &  Monthly gender click dictionary
        # dict{'keyword' : [Men_click, Women_click]}
        ...
        for keyword in keyword_list:
            ...
            # mm_constant = mmc / mmr
            # mw_constant = mwc / mwr
            mm_constant = (mgc_dict[keyword][MEN] / mmr[keyword]) if mmr[keyword] else 0
            mw_constant = (mgc_dict[keyword][WOM] / mwr[keyword]) if mwr[keyword] else 0
