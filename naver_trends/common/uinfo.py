...
# Chrome driver path
CHROME_DRIVER_PATH  = setting_dict.get('CHROME_DRIVER_PATH', None)
...
CUSTOMER_LIST       = [(customer['CUSTOMER_ID'], customer['SECRET_KEY'], customer['ACCESS_LICENCE'], customer['UID'], customer['UPW']) for customer in setting_dict.get('SEARCHAD_INFO', None)]