...
class BigQueryService():
    ...
    def get_table_info(self, client_name:str):
        table     = None
        table_id  = f'{PROJECT_NAME}.{client_name}.{self.table_name}'
        try:
    ...
    def get_latest_date_dict(self, client_name:str):
        ...
        result = self.client.query(
            queries.find_latest_date.format(sep=self.sep, project=PROJECT_NAME, dataset=client_name, table=self.table_name)
        ).result()
